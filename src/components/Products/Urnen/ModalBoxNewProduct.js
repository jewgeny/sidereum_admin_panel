...
let schema = {
  ...
  "properties": {
      ...
      "category": { type: "string", title: "Kategorie", enum: ["see", "bio", "airbrush", "einfach", "handgemalt", "normal"],  enumNames: ["Seeurne", "Biourne", "Airbrush Urne", "Einfache Urne", "Handgemalte Urne", "Normale Urne" ]},
      "file": {
          "type": "string",
          "format": "data-url",
          ...
          ><Button className="buttonConfig buttonNewProduct my-1" type="submit">Senden</Button></Form>
           ...
           {showSuccessMsg &&
                        <div className="alert alert-success mt-3" role="alert">
                           Die neue Urne wurde erfolgreich in die Liste hinzugefügt
                        </div>
            }
